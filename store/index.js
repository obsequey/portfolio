export const state = () => ({
  projects: [
    {
      id: 0,
      name: 'Сайт Правозащитного Совета Санкт-Петербурга',
      img: '../assets/img/hrcspb.jpg',
      ...
      description: `
        ...
        <p>Ut bibendum pharetra fermentum. In suscipit ipsum vitae euismod condimentum. Vestibulum fermentum sit amet diam eu fringilla. Morbi at accumsan arcu. Vivamus ut vehicula eros. Phasellus congue, mauris quis venenatis dignissim, velit sem dictum augue, sit amet vehicula nisl dui sed metus. Nam condimentum nibh a tristique pharetra. Integer tristique enim sed tristique sagittis. Sed posuere finibus dui, eu rhoncus magna hendrerit ut. Mauris non eros at felis sagittis imperdiet. Donec lacinia vel odio ut porttitor. Maecenas eget ipsum nec neque pharetra vestibulum a non libero. Nam sed justo porta, venenatis tellus ac, condimentum erat.</p> 
      `
    }
  ],
  socials: [
